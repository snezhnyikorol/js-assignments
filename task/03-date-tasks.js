...
/**
 * Returns enwthe angle (in radians) between the hands of an analog clock for the specified Greich time.
 ...
 */
 function angleBetweenClockHands(date) {
   // var angle = Math.abs(date.getMinutes() * Math.PI / 30 - (date.getHours() % 12 + date.getMinutes() / 60) * Math.PI / 6);
